...
window.CATS = [
  {
    ...
    arts: ['partner-login', 'partner-customize', 'partner-reset-password'],
  ...
  },
  {
    ...
    arts: ['partner-tenant-list', 'partner-create-tenant', 'partner-tenant-detail'],
  ...
  },
  {
    ...
    arts: ['partner-faq-getting-started', 'partner-faq-tenants', 'partner-faq-partner', 'partner-tips'],
  ...
  {
    id: 'partner-troubleshoot',
    title: '故障排查',
    bg: '#fee2e2', fg: '#dc2626',
    desc: '快速解决合作伙伴模块中常见的登录、租户和资源问题。',
    arts: ['partner-troubleshoot-main'],
    icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><circle cx="12" cy="12" r="10"/><path d="M12 8v4"/><path d="M12 16h.01"/></svg>'
  },
];
...
window.ARTS = {
  ...
  'partner-reset-password': { cat: 'partner-setup', title: '如何重置密码', exc: '使用忘记密码链接重置密码的分步指南。', body: '<p>如果您忘记了密码，请按照以下步骤重置并重新访问您的账户。</p><h2>如何重置密码</h2><ol><li><strong>点击「忘记密码？」</strong><br>在登录页面，点击密码栏上方的 <strong>Forgot Password?</strong> 链接。<img class="screenshot" src="../images/reset-pw-step1.png" alt="登录页面 — 点击忘记密码"></li><li><strong>输入您的电子邮件地址</strong><br>输入您注册的电子邮件地址，然后点击 <strong>Send Verification Code</strong>。<img class="screenshot" src="../images/reset-pw-step2.png" alt="输入电子邮件地址"></li><li><strong>查看您的电子邮件</strong><br>您将收到一封包含 <strong>6位授权码</strong> 的电子邮件。请尽快使用，因为它很快就会过期。<img class="screenshot" src="../images/reset-pw-step3.png" alt="查看电子邮件获取授权码"></li><li><strong>输入验证码并设置新密码</strong><br>输入6位验证码，然后输入新密码。<img class="screenshot" src="../images/reset-pw-step4.png" alt="输入验证码并设置新密码">它必须满足以下要求：<ul><li>至少8个字符</li><li>大写字母 (A&ndash;Z)</li><li>小写字母 (a&ndash;z)</li><li>数字 (0&ndash;9)</li><li>特殊字符 (!@#$%^&amp;*)</li></ul>完成后点击 <strong>Reset Password</strong>。</li><li><strong>密码重置成功！</strong><br>完成！点击 <strong>Back to Sign In</strong>，使用新密码登录。<img class="screenshot" src="../images/reset-pw-step5.png" alt="密码重置成功"></li></ol><div class="tip"><strong>安全提示：</strong>使用强且独特的密码。您的授权码很快就会过期 &mdash; 请在一次会话中完成重置。</div>' },

  'partner-faq-partner': {
    cat: 'partner-help',
    title: '合作伙伴',
    exc: '关于日常合作伙伴运营、支持流程和账户安全的常见问题。',
    body: '<p>关于日常合作伙伴运营的常见问题。</p><div class="ts-item"><div class="ts-q" onclick="toggleTs(this)">我可以在多台设备上登录吗？<svg class="ts-ch" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="m6 9 6 6 6-6"/></svg></div><div class="ts-a"><div class="ts-a-inner">可以，但请避免在公共或共享设备上登录。在共享设备上，每次使用后务必退出登录。</div></div></div><div class="ts-item"><div class="ts-q" onclick="toggleTs(this)">如何退出合作伙伴模块？<svg class="ts-ch" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="m6 9 6 6 6-6"/></svg></div><div class="ts-a"><div class="ts-a-inner">点击右上角的用户图标，选择<strong>"退出登录"</strong>。</div></div></div><div class="ts-item"><div class="ts-q" onclick="toggleTs(this)">为什么我的控制台数据不更新？<svg class="ts-ch" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="m6 9 6 6 6-6"/></svg></div><div class="ts-a"><div class="ts-a-inner">请刷新浏览器，或退出后重新登录。如问题持续，请联系您的支持团队。</div></div></div><div class="ts-item"><div class="ts-q" onclick="toggleTs(this)">我可以自定义控制台布局吗？<svg class="ts-ch" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="m6 9 6 6 6-6"/></svg></div><div class="ts-a"><div class="ts-a-inner">控制台布局是固定的，但您可以通过切换主题模式和语言来个性化您的使用体验。</div></div></div><div class="ts-item"><div class="ts-q" onclick="toggleTs(this)">配额增加、账户限制或紧急支持应联系谁？<svg class="ts-ch" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="m6 9 6 6 6-6"/></svg></div><div class="ts-a"><div class="ts-a-inner">账户和配额相关问题请联系超级管理员。产品问题或故障请联系 Doc-Scribe 支持渠道。</div></div></div>'
  },

  // ── 故障排查 ──────────────────────────────────────────────────────────────────

  'partner-troubleshoot-main': {
    cat: 'partner-troubleshoot',
    title: '常见问题故障排除',
    exc: '合作伙伴模块最常见问题的快速解决方案。',
    body: '<p>在下方查找合作伙伴模块常见问题的解决方案。如未列出您的问题，请联系超级管理员或 Doc-Scribe 支持团队。</p><div class="ts-item"><div class="ts-q" onclick="toggleTs(this)">无法登录<svg class="ts-ch" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="m6 9 6 6 6-6"/></svg></div><div class="ts-a"><div class="ts-a-inner">&bull; 确认您使用的是正确的注册邮箱和密码<br>&bull; 临时密码可能已过期 — 在登录页面点击<strong>忘记密码？</strong>进行重置<br>&bull; 清除浏览器缓存和 Cookie，然后重试<br>&bull; 如问题持续，请联系超级管理员</div></div></div><div class="ts-item"><div class="ts-q" onclick="toggleTs(this)">未收到登录邮件<svg class="ts-ch" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="m6 9 6 6 6-6"/></svg></div><div class="ts-a"><div class="ts-a-inner">&bull; 检查垃圾邮件或垃圾文件夹<br>&bull; 向超级管理员确认注册邮箱地址<br>&bull; 请超级管理员重新发送您的登录凭据</div></div></div><div class="ts-item"><div class="ts-q" onclick="toggleTs(this)">临时密码已过期<svg class="ts-ch" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="m6 9 6 6 6-6"/></svg></div><div class="ts-a"><div class="ts-a-inner">&bull; 临时密码仅在短时间内有效<br>&bull; 在登录页面点击<strong>忘记密码？</strong>申请新的重置链接<br>&bull; 如未收到重置邮件，请立即联系超级管理员</div></div></div><div class="ts-item"><div class="ts-q" onclick="toggleTs(this)">租户列表为空<svg class="ts-ch" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="m6 9 6 6 6-6"/></svg></div><div class="ts-a"><div class="ts-a-inner">&bull; 刷新浏览器，或退出后重新登录<br>&bull; 确认您使用的是正确的合作伙伴账号<br>&bull; 如果刚创建了租户，请等待几秒后刷新页面</div></div></div><div class="ts-item"><div class="ts-q" onclick="toggleTs(this)">无法创建租户<svg class="ts-ch" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="m6 9 6 6 6-6"/></svg></div><div class="ts-a"><div class="ts-a-inner">&bull; 您可能已达到租户配额上限 — 系统将显示：<em>"您已达到租户数量上限"</em><br>&bull; 请联系超级管理员申请增加配额<br>&bull; 确保所有必填字段（租户名称、公司域名、管理员邮箱）均已填写</div></div></div><div class="ts-item"><div class="ts-q" onclick="toggleTs(this)">租户显示为已暂停或已取消<svg class="ts-ch" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="m6 9 6 6 6-6"/></svg></div><div class="ts-a"><div class="ts-a-inner">&bull; 租户订阅可能已到期 — 在租户详情页查看结束日期<br>&bull; 联系超级管理员续期或重新激活订阅<br>&bull; 请勿创建新租户 — 申请重新激活现有租户</div></div></div><div class="ts-item"><div class="ts-q" onclick="toggleTs(this)">资源使用预警 — 90%以上显示红色<svg class="ts-ch" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="m6 9 6 6 6-6"/></svg></div><div class="ts-a"><div class="ts-a-inner">&bull; 租户已消耗其分配的 Token、存储或席位的 90% 以上<br>&bull; 考虑升级租户套餐或优化资源使用<br>&bull; 在租户被封锁前联系超级管理员提高资源上限</div></div></div><div class="ts-item"><div class="ts-q" onclick="toggleTs(this)">控制台数据未更新<svg class="ts-ch" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="m6 9 6 6 6-6"/></svg></div><div class="ts-a"><div class="ts-a-inner">&bull; 刷新页面或退出后重新登录<br>&bull; 等待几分钟让最新更改生效<br>&bull; 如问题持续，请联系 Doc-Scribe 支持渠道</div></div></div><div class="ts-item"><div class="ts-q" onclick="toggleTs(this)">创建租户时出现验证错误<svg class="ts-ch" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="m6 9 6 6 6-6"/></svg></div><div class="ts-a"><div class="ts-a-inner">&bull; <strong>字段红色高亮</strong> — 必填字段未填写，请填写所有必填字段<br>&bull; <em>"请输入有效的邮箱地址"</em> — 检查管理员邮箱格式（如 admin@company.com）<br>&bull; <em>"结束日期必须在开始日期之后"</em> — 将结束日期设置在开始日期之后</div></div></div>'
  },
...
window.VIDEOS = [
  ...
  { id: 'UmLDcJ7pvK4', label: 'Partner 教程 — 入门指南', title: 'Partner 模块：首次登录与控制台概览', desc: 'Doc-Scribe.ai 平台全面介绍 — 从文档摄取到 AI 驱动的提取与工作流触发。', thumb: '../images/gettingstarted.png', url: 'https://youtu.be/UmLDcJ7pvK4' },
  { id: 'WtNTT6OnOyk', label: 'Partner 教程 — 租户管理', title: '安全性与架构', desc: '深入了解 Doc-Scribe.ai 的安全模型、数据架构与部署注意事项。', thumb: '../images/docscribe_structure.png', url: 'https://youtu.be/WtNTT6OnOyk' }
];
